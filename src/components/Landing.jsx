  ...
  return (
    <section className="min-h-screen flex items-center pt-16 md:pt-24">
      <div className="max-w-7xl mx-auto w-full px-6">
        ...
        {/* ── MOBILE LAYOUT (flex-col, hidden on md+) ── */}
        <div className="flex flex-col items-center gap-10 md:hidden">
          ...
          <div className="text-center space-y-1">
            ...
            <h1
              className="text-4xl font-medium tracking-wide italic"
          ...
          <div className="flex flex-col items-center gap-4">
            <motion.img
              ...
              className="w-52 h-52 object-cover rounded-full border border-gray-200"
              animate={{ y: [0, -3, 0], rotate: [0, 3, -2, 0] }}
              transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }}
            />
            <a
              href="mailto:ambrishchaurasiya.work@gmail.com"
              className="text-sm text-gray-500 hover:text-yellow-400 transition duration-300 tracking-wide glow-animate"
            >
          ...
          <div className="text-center space-y-1">
            ...
            <h3
              className="text-3xl font-medium tracking-wide italic"
              style={{ fontFamily: '"Times New Roman", Times, serif' }}
            >
              my portfolio
            </h3>
